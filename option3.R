...
gg <- bind_rows(graph_new, graph_old)

gg$reltrad <- factor(gg$reltrad, levels = c("Evangelical", "Mainline", "Black Prot.", "Non-Denom.", "Catholic", "Jewish", "Other Faith", "No Religion", "Unclassified"))
...
gg %>% 
  ...
  y_pct() + 
  labs(x = "", y = "", title = "Creating a New Non-Denominational Category", caption = "Data: GSS 1972-2018") +
  ggsave("D://new_reltrad/images/option3.png", type = "cairo-png", width = 8)
