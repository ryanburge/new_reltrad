...
graph %>% 
  ...
  y_pct() +
  theme_gg("Abel") +
  add_text(x = 2008, y = .80, word = "Non-Denoms.", sz = 4) +
  add_text(x = 1995, y = .38, word = "Something\nElse", sz = 4) +
  add_text(x = 2005, y = .04, word = "Other Prot.", sz = 4) +
  scale_x_continuous(breaks = c(1978, 1988, 1998, 2008, 2018)) +
  labs(x = "", y = "Share of the Unclassified", title = "", caption = "") +
  ggsave("D://new_reltrad/images/stripped_fig2.png", type = "cairo-png", width = 8)
